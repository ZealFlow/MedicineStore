    ...
    class CreatedProductController {
        ...
        public function invoke() {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                echo $bProduct->insertProduct($brand, $category, $unit, $groupProduct, $productName, $quantity, $description, $attributes);
                $bCost->insertCostProduct(new Cost($cost, $bProduct->getProductID_newInsert()));

                foreach ($uploadedImages as $image) {
                    $bImage->insertImage($bProduct->getProductID_newInsert(), $image->getPathImage());
                }

            }

            include 'C:\xampp\htdocs\MedicineStore\SourceFiles\System\application\PL\webapp\views\admin\pages\PageCreatedProduct.php';
        }
    }

    $createdProductController = new CreatedProductController();
    $createdProductController->invoke();
