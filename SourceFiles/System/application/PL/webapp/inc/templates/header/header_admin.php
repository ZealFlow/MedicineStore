        ...
        <div class="sidepanel-inner d-flex flex-column">
            ...
            <div class="app-branding">
                <a class="app-logo" href="index.html"><img class="logo-icon me-2"
                        src="https://www.onlinelogomaker.com/blog/wp-content/uploads/2017/12/medical-logo-design-1024x819.jpg"
                        alt="logo"><span class="logo-text">MEDICINE</span></a>
            ...
            <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
                <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                    <li class="nav-item has-submenu">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a class="nav-link submenu-toggle"
                            href="#" data-bs-toggle="collapse" data-bs-target="#submenu-1" aria-expanded="false"
                            aria-controls="submenu-1"> <span class="nav-icon">
                            ...
                            </span> <span class="nav-link-text">Pages</span> <span class="submenu-arrow"> <svg
                                    width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-chevron-down"
                                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd"
                        ...
                        <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                            <ul class="submenu-list list-unstyled">
                                <li class="submenu-item"><a class="submenu-link"
                                        href="/WebeCommerce/GroupProductServlet">Group Product</a></li>
                                <li class="submenu-item"><a class="submenu-link"
                                        href="/WebeCommerce/BrandServlet">Brands</a></li>
                                <li class="submenu-item"><a class="submenu-link"
                                        href="/WebeCommerce/CategoryServlet">Category</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ --> <a class="nav-link"
                            href="http://medicinestore.io/SourceFiles/System/application/PL/controllers/ChartController.php"> <span class="nav-icon">
